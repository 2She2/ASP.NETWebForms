...
namespace _03_PageLifecycle
{
    public partial class Lifecycle : System.Web.UI.Page
    {
        ...
        protected void ButtonTest_Load(object sender, EventArgs e)
        {
        ...
        protected void ButtonTest_PreRender(object sender, EventArgs e)
        {
            Response.Write("ButtonOK_PreRender invoked" + "<br/>");
        }

        protected void ButtonTest_Unload(object sender, EventArgs e)
        {
